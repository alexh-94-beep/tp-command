...
-- ============================================================================
-- security definer + set search_path = public ist hier zwingend: ohne
-- security definer triggert die SELECT-Policy auf public.users beim Lesen
-- in auth_role() erneut is_admin()/auth_role() -> RLS-Rekursion.
