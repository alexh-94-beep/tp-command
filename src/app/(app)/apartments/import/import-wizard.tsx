...
export default function ImportWizard() {
  ...
  // Scroll-Container des App-Layouts nach ganz oben scrollen.
  useEffect(() => {
    if (done || preview) {
        ...
        <div className="space-y-4 rounded-xl border border-slate-200 bg-white p-6">
          ...
          <div className="max-h-96 overflow-auto rounded-md border border-slate-200">
            <table className="min-w-full divide-y divide-slate-200 text-xs">
              <thead className="sticky top-0 bg-slate-50 text-left tracking-wide text-slate-500 uppercase">
                <tr>
          ...
          <div className="border-t border-slate-200 pt-4">
            ...
            <div className="mt-2 space-y-2 text-sm">
              <label className="flex items-start gap-2">
                ...
                />
                <span>
                  <strong>Nur neue anlegen</strong> – bestehende Wohnungen bleiben unverändert.
                  Sicher für den ersten Import.
                </span>
              </label>
              <label className="flex items-start gap-2">
                <input
                ...
                />
                <span>
                  <strong>Aktualisieren (Upsert)</strong> – neue anlegen, bestehende mit den
                  Werten aus dem Excel überschreiben.
                </span>
              </label>
            </div>
