...
export const metadata = { title: 'Wohnung · TP-Command' };
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="flex flex-wrap gap-2">
        ...
        <Badge tone={ownershipTone[apartment.ownership]}>
          {ownershipLabel[apartment.ownership]}
        </Badge>
      ...
      <div className="grid grid-cols-1 gap-4 lg:grid-cols-2">
        <Card>
          ...
          <CardBody>
            <dl className="grid grid-cols-2 gap-x-4 gap-y-4">
              ...
              <Field label="Fläche" value={apartment.size_sqm ? `${apartment.size_sqm} m²` : null} />
        ...
        <Card>
          ...
          <CardBody>
            <dl className="grid grid-cols-2 gap-x-4 gap-y-4">
              ...
              <Field label="Kurzzeitpauschale" value={formatMoney(apartment.short_term_flat_rate)} />
              <Field
                label="Parkplatz"
                value={apartment.has_parking ? `Ja (${formatMoney(apartment.parking_fee)})` : 'Nein'}
              />
        ...
        {apartment.notes && (
          <Card className="lg:col-span-2">
            ...
            <CardBody>
              <p className="whitespace-pre-wrap text-sm text-slate-700">{apartment.notes}</p>
            </CardBody>
          </Card>
        )}
      </div>
