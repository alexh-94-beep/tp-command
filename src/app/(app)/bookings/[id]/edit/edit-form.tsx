...
export default function EditBookingForm({ booking }: { booking: BookingFormState }) {
  ...
  // Lokaler State für die Datumsfelder (DateInput braucht value/onChange)
  const [startDate, setStartDate] = useState(booking.start_date);
  const [endDate, setEndDate] = useState(booking.end_date === OPEN_END_DATE ? '' : booking.end_date);
          ...
          <CardBody className="space-y-4">
            <div className="grid grid-cols-2 gap-3 lg:grid-cols-4">
              <div>
                ...
                <select className={inputCls} name="rental_type" defaultValue={booking.rental_type}>
              ...
              <div>
                ...
                <input
                  ...
                  required
                />
                {fe.rent_amount && <p className="mt-1 text-xs text-red-600">{fe.rent_amount[0]}</p>}
              </div>
              <div>
