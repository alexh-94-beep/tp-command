...
export async function updateBooking(formData: FormData): Promise<UpdateBookingResult> {
  ...
  // Aktuelle Buchung laden, um apartment_id zu bekommen
  ...
  // Verfügbarkeits-Check (eigene Buchung ignorieren) – nur wenn nicht storniert
  ...
  // Workflow-Aufgaben: fehlende ergänzen (z.B. wenn Mietart geändert wurde)
  // und Fälligkeitsdaten der offenen Aufgaben neu berechnen.
