...
// Node 20.x hat noch keine native WebSocket – supabase-js 2.106+ braucht eine.
// Polyfill MUSS vor dem createClient-Aufruf stehen.
import WebSocket from 'ws';
// @ts-expect-error -- ws.WebSocket entspricht ausreichend dem Browser-WebSocket
